...
--
--
-- Table structure for table `manager login`
--

CREATE TABLE `mgr_login`(
  `id` int(11) NOT NULL,
  `name` varchar(20),
...
--
-- Dumping data for table `manager login`
--
INSERT INTO `mgr_login` (`id`,`name`,`email`,`password`) VALUES
(01,'RamKumar','RamKumar@gmail.com','Ram6.Kumar'),
(03,'Sathya','Sathya@gmail.com','Sathya.Raj'),
(02,'Prakash','Prakash@gmail.com','Prakash456');


-- Table structure for table `Cashier login`
--
...
--
-- Dumping data for table `Cashier login`
--
INSERT INTO `cas_login` (`id`,`name`,`email`,`password`) VALUES
(03,'Cashier','Cashier@gmail.com','Cashier1'),
(04,'Poorna','Poorna@gmail.com','Poorna@cashier');
...
(6, '2', 'Dear Ali,<br>\r\nOur privacy policy has been changed please visit nearest <kbd> KBC </kbd> branch for new prospectus.', '2017-12-16 06:29:23');
...
ALTER TABLE `mgr_login`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `cas_login`
  ADD PRIMARY KEY (`id`);
