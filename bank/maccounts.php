...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
    <img src="images/banklogo.png" width="30" height="30" class="d-inline-block align-top" alt="">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">\
       	...
       	<button class="btn btn-outline-success">Welecome <?php echo $_SESSION['active_manager']; ?></button>
...
{
  if (!$con->query("insert into cas_login (name,email,password) values ('$_POST[name]','$_POST[email]','$_POST[password]')")) {
    echo "<div claass='alert alert-success'>Failed. Error is:".$con->error."</div>";
  }
}
if (isset($_GET['del']) && !empty($_GET['del']))
{
  $con->query("delete from cas_login where id ='$_GET[del]'");
}
  $array = $con->query("select * from cas_login");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form method="POST">
          Enter Details
         <input class="form-control w-75 mx-auto" type="text" name="name" required placeholder="Full Name">
